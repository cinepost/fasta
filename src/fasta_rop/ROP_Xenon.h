#ifndef __ROP_Xenon_h__
#define __ROP_Xenon_h__
...
#include "xenon_lib/XN_GBuffer.h"
#include "xenon_lib/XN_Render.h"
...
class ROP_Xenon : public ROP_Node {
public:
    ...
    static OP_Node              *myConstructor(OP_Network *net, const char*name,
                                                OP_Operator *op);
protected:
             ROP_Xenon(OP_Network *net, const char *name, OP_Operator *entry);
    virtual ~ROP_Xenon();

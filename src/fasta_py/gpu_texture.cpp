...
void export_GPU_TextureManager() {
	boost::python::class_<GPU_TextureManager, boost::noncopyable>("GPU_TextureManager", boost::python::no_init)
		.def("textureFromImage2D", &GPU_TextureManager::textureFromImage2D,
